...
tmux new-window -t FULLO2:3 -n 'FULLO2-ACTIX' 'cd ~/work/rust/fullo-rust/fullo-actix; nvim .'
tmux new-window -t FULLO2:4 -n 'FULLO2-ANGULAR' 'cd ~/work/rust/fullo-rust/fullo-app; nvim .'
tmux a
